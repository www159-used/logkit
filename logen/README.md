...
实例 YAML 语法见 [**logen-dsl** 规范](https://www159-used.github.io/logkit/logen-dsl/intro.html)。**logen 命令行**见 [**cli**](https://www159-used.github.io/logkit/cli/intro.html)。示例文件在 [**`etc/`**](../etc/)。
